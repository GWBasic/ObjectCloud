...
java -cp ./js.jar org.mozilla.javascript.tools.jsc.Main -package com.objectcloud.javascriptprocess -o ThrowFunction -d ./JavascriptProcess/Classes ThrowFunction.js
rm json2.js
rm JSONstringify.js
rm JSONparse.js
