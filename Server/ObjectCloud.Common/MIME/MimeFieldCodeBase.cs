...
namespace ObjectCloud.Common.MIME
{
	...
	/// 
	/// </summary>
	public class MimeFieldCodeBase : MIME.MimeCode
	{
	...
	public class MimeFieldCodeAddress : MIME.MimeFieldCodeBase
	{
	...
	public class MimeFieldCodeParameter : MIME.MimeFieldCodeBase
	{
