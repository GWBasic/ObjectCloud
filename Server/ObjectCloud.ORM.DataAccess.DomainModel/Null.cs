...
{
    /// <summary>
    /// Holder for nullable column types
    /// </summary>
    public class Null
    {
        /// <summary>
        ...
        private static readonly ColumnType _IntColumnType = new ColumnType(ColumnType.SqlTypes.Int, ColumnType.Null.Allowed);
        ...
        private static readonly ColumnType _LongColumnType = new ColumnType(ColumnType.SqlTypes.Long, ColumnType.Null.Allowed);
        ...
        private static readonly ColumnType _StringColumnType = new ColumnType(ColumnType.SqlTypes.String, ColumnType.Null.Allowed);
        ...
        private static readonly ColumnType _GuidColumnType = new ColumnType(ColumnType.SqlTypes.Guid, ColumnType.Null.Allowed);
        ...
        private static readonly ColumnType _TimeStamp = new ColumnType(ColumnType.SqlTypes.Long, ColumnType.Null.Allowed, typeof(DateTime?), "new DateTime({0})", "{0}.Value.Ticks");
